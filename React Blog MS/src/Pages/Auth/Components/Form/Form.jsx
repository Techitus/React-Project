...
const Form = ({ area, adding }) => {
  const [data, setData] = useState({
    email: "", //useState ko use le initail value  lai empty rakheko
    username: "",
    password: "",
  });
  //tala call gareko xa function
  const handelChangee = (a) => {
    const { name, value } = a.target;
    setData({
      ...data, // ... ko kam vanenko paileko value jasto xa testi rakhnii ho no change
      [name]: value, //name maa value ko data hakni name muni use xa like name:"email"
    });
  };
            ...
            <form onSubmit={handelResister}>
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="relative">
                    <button className="bg-blue-500 text-white rounded-md px-2 py-1 hover:bg-blue-900 ">
                      Submit
                    </button>
                  </div>
                </div>
